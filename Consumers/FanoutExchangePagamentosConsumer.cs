...
{
    public class FanoutExchangePagamentosConsumer : BackgroundService
    {
        private readonly string QUEUE_NAME = "processar-pagamentos";
        private readonly RabbitMqConfiguration _config;
        private readonly IConnection _connection;
        private readonly IModel _channel;
        public FanoutExchangePagamentosConsumer(IOptions<RabbitMqConfiguration> option)
        {
