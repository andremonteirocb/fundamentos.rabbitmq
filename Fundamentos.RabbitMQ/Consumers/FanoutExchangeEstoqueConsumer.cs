...
{
    public class FanoutExchangeEstoqueConsumer : BackgroundService
    {
        private readonly string QUEUE_NAME = "atualizar-estoque";
        private readonly RabbitMqConfiguration _config;
        private readonly IConnection _connection;
        private readonly IModel _channel;
        public FanoutExchangeEstoqueConsumer(IOptions<RabbitMqConfiguration> option)
        {
