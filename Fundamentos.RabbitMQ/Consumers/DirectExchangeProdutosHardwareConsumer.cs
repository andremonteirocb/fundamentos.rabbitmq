...
{
    public class DirectExchangeProdutosHardwareConsumer : BackgroundService
    {
        private readonly string QUEUE_NAME = "produto-hardware";
        private readonly string ROUTING_KEY = "hardware";
        private readonly RabbitMqConfiguration _config;
        private readonly IConnection _connection;
        private readonly IModel _channel;
        public DirectExchangeProdutosHardwareConsumer(IOptions<RabbitMqConfiguration> option)
        {
